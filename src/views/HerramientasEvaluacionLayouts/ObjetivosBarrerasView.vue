<template>
  <div class="tool-view">
    ...
    <div class="content">
      <img src="@/assets/img/herramientasEvaluacion/objetivosBarreras.png" alt="Oportunidades y barreras" class="image" />
    ...
    <div class="videos-section">
      ...
      <div class="videos-container">
        <a href="https://www.youtube.com/watch?v=UPAjKBYp2Vs" target="_blank" rel="noopener noreferrer" class="video-link">
          <span class="video-icon">▶</span>
          <span class="video-text">Ver video de oportunidades GoD</span>
        </a>
        <a href="https://www.youtube.com/watch?v=om1MYQ-9YBQ" target="_blank" rel="noopener noreferrer" class="video-link">
          <span class="video-icon">▶</span>
          <span class="video-text">Ver video de barreras GoD</span>
        </a>
      </div>
    </div>
    ...
    <div v-else class="login-prompt">
      <p class="login-message">
        Por favor, <router-link to="/" class="login-link">inicia sesión</router-link> para acceder a la herramienta.
      </p>
    </div>
  </div>
</template>
